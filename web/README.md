...
- La UI ahora usa la paleta negro/dorado traslúcido del sistema NUUP.SPACE. Ajusta cualquier variable en `styles.css` (sección `:root`) para afinar tonos, sombras o radios sin alterar el layout.
